  ...
  const injectReportSupportPopup = () => {
    ...
    style.textContent = `
      #anipastaReportPopup {
        ...
        box-shadow: 0 8px 24px rgba(0, 0, 0, .38), inset 0 1px 0 rgba(255, 255, 255, .03);
      ...
      #anipastaReportPopup:hover {
        border-color: rgba(200, 255, 0, .62);
        background: rgba(27, 32, 27, .98);

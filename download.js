(() => {
  ...
  function placeDownloadBar() {
    ...
    bar.classList.add('download-below-player');
    if (bar.parentElement !== column || bar.previousElementSibling !== document.querySelector('#watchPage .episodesPanel')) column.appendChild(bar);
  }
  ...
  function addDownloadButton() {
    ...
    bar.className = 'animeDownloadBar download-below-player';
  ...
  function sync() {
    addDownloadButton();
    if (window.location.hash === '#library' || window.AnipastaApp?.getView?.() === 'library') {
      document.getElementById('downloadPage')?.classList.add('hidden');
